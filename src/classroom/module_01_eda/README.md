...
| **9** | **Cuestionario / guía de preguntas y respuestas sobre Autoencoders** | Recurso de repaso y autoevaluación con preguntas desarrolladas sobre arquitectura encoder-decoder, espacio latente, bottleneck, reconstrucción, pérdida, regularización, denoising, anomalías, VAE y evaluación de representaciones. | [![Abrir HTML](https://img.shields.io/badge/Abrir%20HTML-Cuestionario%20Autoencoders-2563eb?style=for-the-badge&logo=html5&logoColor=white)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/data-science-for-business-models/blob/52d9cb86a3953b441bcc2db7dfb78081081bba19/src/classroom/module_01_eda/html/Autoencoders_guia_preguntas_respuestas.html) |
| **10** | **Glosario completo de Autoencoders** | Glosario interactivo con conceptos desarrollados sobre aprendizaje no supervisado, encoder, decoder, espacio latente, bottleneck, función de pérdida, regularización, anomalías, reducción de dimensionalidad, variantes, VAE, evaluación y aplicaciones. | [![Abrir HTML](https://img.shields.io/badge/Abrir%20HTML-Glosario%20Autoencoders-7c3aed?style=for-the-badge&logo=html5&logoColor=white)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/Autoencoders_glosario.html) |
...
| **Redes neuronales: guía de preguntas y respuestas desarrolladas** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Guía interactiva de estudio sobre redes neuronales artificiales, organizada en preguntas con respuestas completamente desarrolladas. El material aborda pesos, sesgo, funciones de activación, fronteras de decisión, problema XOR, función de pérdida, gradiente, learning rate, forward propagation, backpropagation, regla de la cadena, overfitting, validación y regularización.</p><p>Está pensada como recurso de repaso, autoevaluación y explicación conceptual para comprender cómo una red neuronal aprende ajustando parámetros internos para transformar entradas en predicciones, combinando operaciones lineales, activaciones no lineales y entrenamiento basado en gradientes.</p></details> | [![Ver Guía Interactiva](https://img.shields.io/badge/Ver%20Gu%C3%ADa-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/redes_neuronales_preguntas_respuestas.html) <br><br> [![Ver en GitHub](https://img.shields.io/badge/Ver%20Archivo-GitHub-181717?style=for-the-badge&logo=github)](https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/redes_neuronales_preguntas_respuestas.html) |
| **Redes neuronales: glosario completo interactivo** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Glosario interactivo completo sobre redes neuronales artificiales, neurona artificial, entrada, salida, pesos, sesgo, combinación lineal, funciones de activación, ReLU, sigmoid, tanh, capas, arquitectura, pérdida, gradiente, optimización, propagación, evaluación, regularización, overfitting y generalización.</p><p>El recurso contiene términos desarrollados y organizados por categorías de estudio, con buscador, filtros por categoría, filtros alfabéticos, modo de estudio, modo examen, progreso de lectura y definiciones desplegables. Funciona como material de consulta rápida y apoyo conceptual para acompañar la clase principal y la guía de preguntas y respuestas.</p></details> | [![Ver Glosario Interactivo](https://img.shields.io/badge/Ver%20Glosario-Interactivo-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/redes_neuronales_glosario.html) <br><br> [![Ver en GitHub](https://img.shields.io/badge/Ver%20Archivo-GitHub-181717?style=for-the-badge&logo=github)](https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/redes_neuronales_glosario.html) |
---
...
| **RNN y LSTM: guía de preguntas y respuestas desarrolladas** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Guía interactiva de estudio sobre redes neuronales recurrentes y LSTM, organizada en preguntas con respuestas completamente desarrolladas. El material aborda datos secuenciales, estado oculto, memoria temporal, entrenamiento mediante Backpropagation Through Time, problemas de gradiente, arquitectura LSTM, compuertas, comparación con GRU y Transformers, preparación de datos, validación y aplicaciones.</p><p>Está pensado como recurso de repaso, autoevaluación y explicación conceptual para comprender por qué una RNN introduce memoria secuencial y cómo una LSTM mejora esa memoria mediante mecanismos que aprenden qué conservar, qué olvidar y qué exponer.</p></details> | [![Ver Guía Interactiva](https://img.shields.io/badge/Ver%20Gu%C3%ADa-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/RNN_lstm_preguntas_respuestas.html) <br><br> [![Ver en GitHub](https://img.shields.io/badge/Ver%20Archivo-GitHub-181717?style=for-the-badge&logo=github)](https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/RNN_lstm_preguntas_respuestas.html) |
| **RNN y LSTM: glosario completo desarrollado** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Glosario interactivo completo sobre redes recurrentes, memoria temporal, estados ocultos, entrenamiento, gradientes, LSTM, compuertas, GRU, series temporales, texto, validación, métricas, implementación y aplicaciones.</p><p>El recurso contiene términos desarrollados y organizados por categorías técnicas, con buscador, filtros, modo de estudio, modo examen, progreso de lectura y definiciones desplegables. Funciona como material de consulta rápida y apoyo conceptual para acompañar la clase principal y la guía de preguntas y respuestas.</p></details> | [![Ver Glosario Interactivo](https://img.shields.io/badge/Ver%20Glosario-Interactivo-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/RNN_lstm_glosario_completo.html) <br><br> [![Ver en GitHub](https://img.shields.io/badge/Ver%20Archivo-GitHub-181717?style=for-the-badge&logo=github)](https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/RNN_lstm_glosario_completo.html) |
...
| **CNN: cuestionario con preguntas y respuestas desarrolladas** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir)</em></summary><p>Guía de estudio interactiva sobre redes neuronales convolucionales organizada en 10 preguntas completamente desarrolladas. El recurso permite repasar CNN desde la intuición visual hasta la arquitectura profunda: qué es una red neuronal convolucional, por qué resulta adecuada para imágenes, cómo funciona la convolución, qué rol cumplen los filtros, cómo se generan mapas de características, qué efecto producen padding y stride, cómo se procesan imágenes RGB mediante convoluciones multicanal, para qué sirve el pooling, cómo se combinan capas convolucionales, activaciones y capas densas, cómo se entrena una CNN y cuáles son sus aplicaciones y límites. Incluye buscador interno, filtros por categoría, modo estudio, modo examen, control de tamaño de lectura, apertura y cierre de respuestas, marcado de preguntas estudiadas, barra de progreso, cambio de tema visual, cambio de paleta y opción de impresión.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Cuestionario%20CNN-7c3aed?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/CNN_guia_preguntas_respuestas.html) |
| **CNN: glosario completo interactivo** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir)</em></summary><p>Glosario interactivo y autocontenido para estudiar el vocabulario técnico de las redes neuronales convolucionales. El recurso desarrolla 102 términos organizados en 10 categorías: fundamentos, datos e imagen, convolución, arquitectura, entrenamiento, salida y evaluación, modelos CNN, aplicaciones, implementación e interpretabilidad. Cada término incluye definición, desarrollo conceptual, ejemplo de estudio y relación con otros conceptos. Cubre nociones como imagen digital, píxel, canal, tensor, filtro, kernel, convolución 2D, padding, stride, mapa de características, campo receptivo, pooling, flatten, capa densa, activación, batch normalization, dropout, backpropagation, función de pérdida, optimizador, accuracy, matriz de confusión, transfer learning, fine-tuning, ResNet, backbone, segmentación, detección de objetos, Grad-CAM, análisis de errores, robustez y cambio de dominio. Incluye buscador, filtros por categoría, orden alfabético, modo examen, marcado de términos estudiados, barra de progreso, cambio de tema, cambio de paleta, ajuste de tamaño de texto y opción de impresión.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Glosario%20CNN-059669?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/data-science-for-business-models/blob/main/src/classroom/module_01_eda/html/CNN_glosario.html) |
...
| Recurso | Acceso |
|---|---|
| **Transformer: página única, teoría y simulaciones interactivas** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir)</em></summary><p>Clase interactiva autocontenida sobre Transformers aplicada a NLP. El recurso reúne los fundamentos conceptuales y operativos de la arquitectura Transformer: tokenización, embeddings, codificación posicional, Query, Key, Value, producto Q·K, softmax, matriz de atención, suma ponderada de Values, multi-head attention, encoder, decoder, máscara causal, cross-attention, distribución final sobre vocabulario y lectura crítica de los pesos de atención. Incluye simulaciones visuales para observar cómo una frase se transforma en tokens, cómo cada token atiende a otros elementos del contexto, cómo cambian los pesos según distintas cabezas de atención y cómo un decoder genera texto paso a paso sin mirar tokens futuros. Está pensado como una página única de estudio, con teoría integrada, ejemplos guiados y simulaciones interactivas para comprender el flujo completo de un Transformer desde la entrada textual hasta la generación de salida.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Transformer%20Interactivo-blue?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://raw.githubusercontent.com/sgevatschnaider/data-science-for-business-models/a3e43fd64c5ff057c3654476bc97cc4d0fbf935e/src/classroom/module_01_eda/html/Transformer_pagina_%C3%BAnica.html) |
| **Transformer: cuestionario con preguntas desarrolladas** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir)</em></summary><p>Guía interactiva de estudio con 10 preguntas desarrolladas sobre la arquitectura Transformer. El cuestionario permite repasar de manera ordenada los conceptos centrales del modelo: qué es un Transformer, por qué reemplazó enfoques secuenciales tradicionales, cómo se representan los tokens, qué función cumplen los embeddings y la posición, cómo se construyen Query, Key y Value, cómo se calcula la atención, por qué se usa multi-head attention, cómo funciona el encoder, qué agrega el decoder, cómo se genera texto paso a paso y cuáles son los principales límites de interpretación, sesgo, costo computacional y uso crítico de estos modelos. Cada respuesta está desarrollada con explicación conceptual, fórmulas, ejemplos, claves de examen y orientación pedagógica. Incluye buscador interno, navegación por preguntas, modo estudio/examen, apertura y cierre de respuestas, control de tamaño de lectura, cambio de tema visual, cambio de paleta y seguimiento de progreso.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Cuestionario%20Transformer-purple?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://raw.githubusercontent.com/sgevatschnaider/data-science-for-business-models/main/src/classroom/module_01_eda/html/Transformer_guia_preguntas.html) |
| **Transformer: glosario completo interactivo** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir)</em></summary><p>Glosario interactivo y autocontenido para estudiar el vocabulario técnico de los Transformers. El recurso desarrolla 77 términos organizados en 9 categorías: fundamentos, representación, atención, arquitectura, entrenamiento, generación, modelos, uso y aplicaciones, y límites y evaluación. Cada término incluye una definición desarrollada, explicación de cómo aparece dentro de un Transformer, ejemplo aplicado para estudiar y una clave formal o fórmula cuando corresponde. El glosario cubre conceptos como contexto, secuencia, token, tokenización, vocabulario, embeddings, codificación posicional, d_model, Query, Key, Value, self-attention, softmax, matriz de atención, multi-head attention, encoder, decoder, feed-forward network, layer normalization, conexiones residuales, máscara causal, cross-attention, preentrenamiento, fine-tuning, prompting, generación autoregresiva, temperatura, top-k, top-p, modelos encoder-only, decoder-only, encoder-decoder, RAG, alucinaciones, sesgos, interpretabilidad y evaluación. Incluye buscador, filtros por categoría, filtros alfabéticos, índice lateral, modo estudio/examen, apertura individual o global de términos, marcado de términos estudiados, contador de progreso, cambio de tema visual, cambio de paleta y control de tamaño de lectura.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Glosario%20Transformer-green?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://raw.githubusercontent.com/sgevatschnaider/data-science-for-business-models/main/src/classroom/module_01_eda/html/Transformer_glosario.html) |
...
La **Programación Lineal** es una de las herramientas más importantes dentro de la investigación operativa, la economía aplicada, la ingeniería, la logística, la ciencia de datos y la toma de decisiones empresariales. Su valor central está en permitir transformar problemas reales de asignación de recursos en modelos matemáticos claros, ordenados y resolubles.

En muchas situaciones prácticas, una organización debe decidir cómo utilizar recursos limitados: horas de trabajo, capacidad productiva, presupuesto, materias primas, espacio físico, transporte, energía, tiempo o capital. La Programación Lineal permite responder preguntas como: cuánto producir, qué combinación de productos elegir, cómo minimizar costos, cómo maximizar beneficios, cómo organizar una mezcla óptima de recursos o cómo tomar decisiones cuando existen restricciones simultáneas.

La idea fundamental es construir un modelo compuesto por tres elementos: **variables de decisión**, que representan aquello que se desea determinar; **función objetivo**, que expresa el criterio de optimización; y **restricciones**, que representan los límites técnicos, económicos o físicos del problema. Cuando estos elementos pueden expresarse mediante relaciones lineales, se obtiene un modelo de Programación Lineal.

Su importancia didáctica también es muy grande porque permite comprender conceptos centrales de la optimización: región factible, restricciones activas, vértices, solución óptima, holguras, precios sombra, sensibilidad y dualidad. Estos conceptos no solo sirven para resolver ejercicios matemáticos, sino también para interpretar decisiones reales. Un modelo de Programación Lineal no solo indica cuál es la mejor solución bajo determinados supuestos; también permite analizar qué recursos son críticos, qué restricciones limitan el resultado y cómo cambiaría la solución si varían los datos del problema.

Desde el punto de vista geométrico, la Programación Lineal muestra una propiedad muy poderosa: cuando existe una solución óptima finita, esta se encuentra en algún vértice de la región factible. Esta idea permite entender por qué métodos como el simplex pueden recorrer soluciones extremas hasta encontrar una alternativa óptima. Desde el punto de vista económico, el análisis de sensibilidad convierte al modelo en una herramienta de gestión, porque permite estudiar escenarios y evaluar el impacto de cambios en recursos, costos, utilidades o capacidades.

La **Programación Lineal Entera** amplía este enfoque cuando las decisiones no pueden dividirse en fracciones. En la práctica, muchas decisiones son discretas: abrir o no abrir una planta, contratar una cantidad entera de personas, seleccionar proyectos, asignar camiones, elegir rutas, activar una inversión, comprar máquinas o decidir si una alternativa se realiza o no. En estos casos, no alcanza con permitir variables continuas; es necesario incorporar variables enteras o binarias.

Esta diferencia cambia profundamente la naturaleza del problema. En Programación Lineal continua, la región factible es convexa y el óptimo puede buscarse con herramientas geométricas y algebraicas bien estructuradas. En Programación Lineal Entera, la factibilidad queda restringida a puntos discretos. Por eso, redondear una solución continua no garantiza obtener una solución factible ni óptima. Se requieren métodos específicos como la relajación lineal, la ramificación y cota, los planos de corte y los solvers de optimización entera mixta.

Estudiar Programación Lineal y Programación Lineal Entera permite desarrollar una forma rigurosa de pensar problemas de decisión. No se trata solo de resolver modelos, sino de aprender a formularlos correctamente, interpretar sus resultados, reconocer sus supuestos, evaluar sus límites y utilizar la optimización como apoyo para decisiones productivas, logísticas, financieras, comerciales y estratégicas.

## Recursos interactivos

| Orden | Recurso | Propósito didáctico | Abrir recurso |
| :---: | :--- | :--- | :---: |
| **1** | **Programación Lineal y Entera: guía de preguntas y respuestas desarrolladas** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir)</em></summary><p>Guía interactiva autocontenida sobre Programación Lineal y Programación Lineal Entera. El recurso reúne 15 preguntas con respuestas desarrolladas: 10 preguntas orientadas a Programación Lineal y 5 preguntas orientadas a Programación Lineal Entera. Permite estudiar qué es la Programación Lineal, cómo se formula un modelo, qué representan las variables de decisión, la función objetivo y las restricciones, cómo se interpreta la región factible, por qué el óptimo se encuentra en vértices, qué son las holguras, cómo funciona el método simplex, qué aporta el análisis de sensibilidad y cuáles son los supuestos centrales del modelo lineal. En la parte de Programación Lineal Entera, introduce variables enteras y binarias, relajación lineal, límites del redondeo, ramificación y cota, planos de corte y el uso de solvers. Incluye buscador, filtros por tema y categoría, modo estudio, modo examen, apertura y cierre de respuestas, progreso de estudio, pregunta aleatoria, control de tamaño de texto, cambio de tema visual y opción de impresión.</p></details> | [![Abrir HTML](https://img.shields.io/badge/Abrir%20HTML-Gu%C3%ADa%20PL%20y%20PLE-2563eb?style=for-the-badge&logo=html5&logoColor=white)](https://htmlpreview.github.io/?https://raw.githubusercontent.com/sgevatschnaider/data-science-for-business-models/main/src/classroom/module_01_eda/html/PL_guia_preguntas_respuestas.html) |
| **2** | **Programación Lineal y Entera: glosario completo interactivo** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir)</em></summary><p>Glosario interactivo y autocontenido para estudiar el vocabulario técnico de Programación Lineal y Programación Lineal Entera. El recurso desarrolla 136 términos organizados en 19 categorías técnicas, incluyendo fundamentos, formulación, geometría, región factible, vértices, holgura y bases, simplex, sensibilidad, supuestos, software, soluciones, fundamentos de Programación Lineal Entera, modelización entera, modelización binaria, relajación e integridad, ramificación y cota, planos de corte, aplicaciones y conceptos avanzados. Cada término está desarrollado para comprender qué significa, cómo se interpreta, para qué sirve y qué cuidados requiere al modelar o resolver. Incluye buscador, filtros por tema, filtros por categoría, filtro alfabético, modo estudio, modo examen, apertura y cierre de definiciones, marcado de términos estudiados, progreso de lectura, término aleatorio, ajuste de tamaño de texto, cambio de tema visual y opción de impresión.</p></details> | [![Abrir HTML](https://img.shields.io/badge/Abrir%20HTML-Glosario%20PL%20y%20PLE-059669?style=for-the-badge&logo=html5&logoColor=white)](https://htmlpreview.github.io/?https://raw.githubusercontent.com/sgevatschnaider/data-science-for-business-models/main/src/classroom/module_01_eda/html/PLE_glosario_completo.html) |
