...
| **Notebook del Paradigma EDA (Google Colab)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir)</em></summary><p>Notebook introductorio orientado a presentar el paradigma del Análisis Exploratorio de Datos (EDA) desde una perspectiva conceptual, visual y aplicada. El material desarrolla qué es el EDA, su secuencia de trabajo, la identificación de variables cualitativas y cuantitativas, la estadística descriptiva, el análisis univariado y bivariado, la correlación, la regresión lineal inicial, la detección de anomalías y la exploración visual mediante gráficos. Utiliza el dataset <code>tips</code> de <code>seaborn</code> para ilustrar de forma práctica cómo inspeccionar datos, interpretar distribuciones, estudiar relaciones entre variables y construir una primera comprensión analítica antes del modelado.</p></details> | [![Abrir en Colab](https://img.shields.io/badge/Abrir%20en-Colab-orange?style=for-the-badge&logo=googlecolab)](https://colab.research.google.com/drive/14Vm6DoayZcSnJLpkQpJ_YVciStuR7k5F#scrollTo=46z-kLbfn4Gq) |
